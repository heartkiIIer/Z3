...
class Display extends React.Component {
    ...
    render() {
        ...
        if (window.innerWidth < 700) {
            buttons = <div><div><button className='btn' onClick={submitStressEntry}>Submit Stress</button></div><div><LogoutButton onClick={(e) => LoginControlClass.handleItemClick(e, 'sign-out')} /><br/><br/><br/></div></div>
        } else {
