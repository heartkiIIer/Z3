...
class ItsBedtimeRoutine extends React.Component {
    ...
    selectComponent(){
        ...
        if(this.state.stage === -1 || this.state.routine == null){
            console.log("init");
            return <BedtimeProgressBar key = {this.state.stage} style={{marginTop: 20}} id = "items" title = "It's Bedtime" stage = {100} stages = {100} minutes = {0} timer = {false}/>;
        }
            ...
            if(this.state.stage < this.state.stages){
                ...
                if(this.state.routine[this.state.stage].minutes !== 0) {
                    return <div><h1 style={h1Style} className="alignTextRight">{"Completed: " + this.state.stage.toString() + "/" + this.state.stages.toString()+ " tasks"}</h1> <br/><BedtimeProgressBar key = {this.state.stage} id="items" title={this.state.routine[this.state.stage].task_name}
            ...
            //Nothing remains
                ...
                return <div><h1 style={h1Style} className="alignTextRight">{"Completed: " + this.state.stages.toString() + "/" + this.state.stages.toString() + " tasks"}</h1> <br/><BedtimeProgressBar key = {this.state.stage} id="items" title={"You're done!"}
