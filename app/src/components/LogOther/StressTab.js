 ...
 * This component renders the Stress tab.
 * */
...
export default class StressTab extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div>
                <Tab.Pane id="mainTab" style={{overflow: 'auto', maxHeight: 500 }} attached={false}>
                    ...
                    <button className='btn-info' onClick={this.fetchEvents}><RefreshIcon style={refresh}/></button>
                    <br/><br/>
