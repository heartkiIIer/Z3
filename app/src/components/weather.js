    ...
    render(){
        return (
            <div>
                ...
                <h4 className="whiteText">Current Temperature: {this.KelvintoFahrenheit(this.props.main.temp)}&deg;F</h4>
                <h5 className="whiteText">Feels like: {this.KelvintoFahrenheit(this.props.main.feels_like)}&deg;F</h5>
