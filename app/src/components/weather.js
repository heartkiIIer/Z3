    ...
    render(){
        return (
            <div>
                ...
                <h4 className="whiteText">{this.props.weather.description.charAt(0).toUpperCase() + this.props.weather.description.slice(1)}</h4>
                ...
                <h4 className="whiteText">Wind speed: {Math.floor(this.props.wind.speed * 2.237)} MPH</h4>
            </div>
        );
    };
}
