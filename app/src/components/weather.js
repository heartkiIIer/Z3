    ...
    render(){
        return (
            <div>
                ...
                <h4 className="whiteText">Current Temperature: {this.KelvintoFahrenheit(this.props.main.temp)}&#8457</h4>
                <h5 className="whiteText">Feels like: {this.KelvintoFahrenheit(this.props.main.feels_like)}&#8457</h5>
